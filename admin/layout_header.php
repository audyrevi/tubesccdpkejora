        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="hargalaundry.php" class="waves-effect <?php if($title=='hargalaundrymain'){echo 'active';} ?>"><i class="fa fa-archive fa-fw" aria-hidden="true"></i> Harga Laundry</a>
                    </li>
                    <li>
                        <a href="pengguna.php" class="waves-effect <?php if($title=='pengguna'){echo 'active';} ?>"><i class="fa fa-user fa-fw" aria-hidden="true"></i> Pegawai</a>
                    </li>
                    <li>
